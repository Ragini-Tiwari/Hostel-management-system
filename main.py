...
heading = Label(base, text="HOSTEL MANAGEMENT SYSTEM", font=("Arial 30 bold"), bg="navyblue", fg="white", padx=490, pady=20)
heading.pack()
...
def main():
    global G
    canvas = Canvas(base, bg='navyblue', height=675, width=310)
